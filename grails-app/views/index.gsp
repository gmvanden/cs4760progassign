            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <!-- Link to BooksController's index action -->
                        <g:link controller="BooksController" action="index" class="nav-link">Books</g:link>
                    </li>
                    <li class="nav-item">
                        <!-- Link to AuthorsController's index action -->
                        <g:link controller="AuthorsController" action="index" class="nav-link">Authors</g:link>
                    </li>
                    <li class="nav-item">
